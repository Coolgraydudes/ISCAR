        ...
        <div className="grid grid-cols-3 items-end lg:px-28 lg:pb-10">
          ...
          <div className="flex justify-center pointer-events-auto">
            <button
              ...
              className="relative -mt-56 flex h-14 w-52 items-center justify-center rounded-[20px] border border-white/20 bg-white/5 px-6 backdrop-blur-md transition-all duration-500"
              style={{
                transform: hovered ? "scale(1.05)" : "scale(1)",
