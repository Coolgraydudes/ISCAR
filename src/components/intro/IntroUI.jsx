        ...
        <div className="lg:hidden absolute inset-0 pointer-events-none">
          ...
          <div className="absolute top-[38%] left-1/2 -translate-x-1/2 w-full px-6 flex flex-col items-center text-center gap-6">
            ...
            <button
              ...
              className="pointer-events-auto px-14 py-3 rounded-full border border-white/20 bg-white/5 backdrop-blur-md text-sm tracking-wide text-white active:scale-95 transition"
              style={{ transform: hovered ? "scale(1.05)" : "scale(1)", fontFamily: interSemiBold }}
            >
              Explore
            </button>
          </div>
        ...
        <div className={`hidden lg:flex fixed inset-0 flex-col justify-between py-10 ${uiHidden ? "pointer-events-none" : "pointer-events-auto"}`}>
          <div className="w-full">
            ...
            <nav className="flex w-full justify-between lg:px-28 mt-4" style={{ fontFamily: interTight }}>
              ...
              <BlurText text="GALLERY" delay={600} className="text-[0.8vw]" />
            </nav>
          </div>
          ...
          <div className="grid grid-cols-3 items-end lg:px-28 lg:pb-10">
            ...
            <div className="flex justify-center pointer-events-auto">
              <button
                ...
                onMouseEnter={handleMouseEnter}
                onMouseLeave={handleMouseLeave}
                className="relative -mt-56 flex h-14 w-52 items-center justify-center rounded-[20px] border border-white/20 bg-white/5 backdrop-blur-md transition hover:scale-[1.05]"
            ...
            <div className="flex justify-end">
              <div className="max-w-[15vw] text-right">
                <BlurText text="Official representative body of Abu Dzar students. We bridge ideas, foster innovation, and create a home for every aspiring leader" delay={200} className="text-[0.9vw] leading-relaxed opacity-90" style={{ fontFamily: interTight }} />
              </div>
            </div>
          </div>
        </div>
