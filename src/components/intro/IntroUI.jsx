    ...
    >
      ...
      <div className="lg:hidden absolute inset-0 pointer-events-none">
        <div className="pointer-events-auto absolute top-6 left-6 right-6 flex items-center justify-between">
          <span className="text-3xl font-bold tracking-tight" style={{ fontFamily: clashDisplay }}>
            ISCAR
          </span>
        ...
        <div className="absolute top-[38%] left-1/2 -translate-x-1/2 w-full px-6 flex flex-col items-center text-center gap-6">
          <div className="flex flex-col items-center font-bold" style={{ fontFamily: interTight }}>
          ...
          <button
            ...
            className="pointer-events-auto px-14 py-3 rounded-full border border-white/20 bg-white/5 backdrop-blur-md text-sm transition-transform"
            style={{ 
        ...
        <div className="absolute bottom-10 left-1/2 -translate-x-1/2 w-[80%] text-center text-sm opacity-80" style={{ fontFamily: interTight }}>
          “Official representative body of Abu Dzar students...”
        </div>
      </div>

      {/* --- DESKTOP VIEW (DENGAN CLAMP) --- */}
      <div
        className={`
          hidden lg:flex fixed inset-0 flex-col justify-between py-10
          transition-opacity duration-700 ease-out
          ${exploreClicked ? "opacity-0" : "opacity-100"}
          ${uiHidden ? "pointer-events-none" : "pointer-events-auto"}
        `}
      >
        {/* Top Section: Logo & Nav */}
        <div className="w-full">
          <div className="relative w-full overflow-hidden flex justify-center px-[4vw]">
            <svg
              viewBox="0 0 584 126"
              /* Fluid: Minimal 400px, Ideal 92% layar, Maksimal 1600px */
              className="w-[clamp(400px,92vw,1600px)] h-auto"
              preserveAspectRatio="xMidYMid meet"
              xmlns="http://www.w3.org/2000/svg"
            >
              <defs>
                <filter id="blurIn"><feGaussianBlur in="SourceGraphic" stdDeviation="12" /></filter>
              </defs>
              <path
          ...
          <nav
            className="flex w-full justify-between mt-4 px-[10vw] text-[clamp(0.7rem,0.85vw,1rem)] opacity-80"
            style={{ fontFamily: interTight }}
          >
            <div className="text-left"><BlurText text="ABOUT" delay={400} /></div>
            <div className="text-center"><BlurText text="DIVISIONS" delay={500} /></div>
            <div className="text-right"><BlurText text="GALLERY" delay={600} /></div>
          </nav>
        </div>

        {/* Bottom Section: Side Texts & Explore */}
        <div className="grid grid-cols-3 items-end px-[6vw] pb-10">
          <div className="flex flex-col text-left leading-tight" style={{ fontFamily: interTight }}>
            <BlurText text="Independent" delay={900} className="text-[clamp(0.8rem,1vw,1.2rem)] font-medium" />
            <BlurText text="Student Council" delay={1000} className="text-[clamp(0.8rem,1vw,1.2rem)] font-medium" />
            <BlurText text="Of Abu Dzar" delay={1100} className="text-[clamp(0.8rem,1vw,1.2rem)] font-medium" />
          </div>

          <div className="flex justify-center pointer-events-auto">
            <div className="relative -mt-40 transition-transform duration-300 hover:scale-[1.05]">
              <button
                disabled={exploreClicked}
                onClick={handleExploreClick}
                onMouseEnter={handleMouseEnter}
                onMouseLeave={handleMouseLeave}
                className="flex h-[clamp(3rem,4.5vw,4.5rem)] w-[clamp(10rem,18vw,16rem)] items-center justify-center rounded-2xl border border-white/20 bg-white/5 backdrop-blur-md transition-shadow duration-300 hover:shadow-[0_0_40px_rgba(255,255,255,0.1)]"
                style={{ fontFamily: interSemiBold }}
              >
                <span className="text-[clamp(0.9rem,1vw,1.1rem)] text-white/90">
          ...
          <div className="flex justify-end">
            <div className="max-w-[clamp(200px,18vw,380px)] text-right">
              <BlurText
                ...
                delay={200}
                className="text-[clamp(0.7rem,0.8vw,0.95rem)] leading-relaxed opacity-70"
                style={{ fontFamily: interTight }}
              />
            </div>
          </div>
